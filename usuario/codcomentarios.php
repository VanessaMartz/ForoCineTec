<?php
    ...
    if(!empty($_POST)){
        ...
        if(empty($_POST['respuesta'])){
            ...
            $alert = '<div class="alert alert-danger text-center" role="alert">Debe llenar el campo</div>';
        }else{
                session_start();
                ...
                if($query_insert){
                    ...
                    $alert = '<div class="alert alert-danger text-center" role="alert">Error al publicar el comentario</div>';
                }
